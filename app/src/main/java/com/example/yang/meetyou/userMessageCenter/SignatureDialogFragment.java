...
public class SignatureDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private static final int CHANGE_SIGNATURE = 12;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case CHANGE_SIGNATURE:
                    MyselfPersonalMessageActivity.signature_tv.setText(msg.obj.toString());
                    break;
                default:
                    break;
            }
    ...
    private void setSignature() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String requestURL = "http://119.29.224.50/meetyou/public/updateUserInfo?operation=DESCRIPTION&user_account=" + account + "&value=" + signature;
                    ...
                    if (response.isSuccessful()) {
                        try {
                            ...
                            if (status == 305) {
                                ...
                                handler.obtainMessage(CHANGE_SIGNATURE, jsonObject1.getString("description")).sendToTarget();
                            }else if(status == 306){
                                handler.obtainMessage(SHOW_TOAST,msg).sendToTarget();
                            }
